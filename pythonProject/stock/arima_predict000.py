...
def run_arma(original_ts, maxar=7, maxma=7):
    ...
    if test_stationarity(original_ts_log.ix[:, 0]) < 0.05:
        diffn = 0
...
if __name__ == '__main__':
    ...
    for i in range(start_date, end_date):
        ...
        rate = forecast[0]/original_ts.ix[i, 0]-1
    ...
    df.to_csv('C:/Users/Administrator/Desktop/stockpredict/5.24change/'+code+'.csv')
