...
if __name__ == '__main__':
    ...
    start_date = original_ts[(original_ts.date == '2017-01-04')].index.tolist()[0]
    original_ts = original_ts.set_index(["date", ])

    # print(len(original_ts))
    predict_ts = original_ts['2016-01-01':'2017-01-01']
    ...
    df.to_csv('C:/Users/Administrator/Desktop/stockpredict/ARIMA/SN444'+code+'.csv')
